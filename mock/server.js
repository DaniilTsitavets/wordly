...
const subtopics = [
  { id: 1, topic_id: 1, name: 'Кухонная утварь', description: 'Посуда и кухонные принадлежности',
    image_url: 'https://placehold.co/400x300?text=Kitchen', sort_order: 1,
    disabled_mechanics: [], status: 'in_progress' },
  { id: 2, topic_id: 1, name: 'Продукты питания', description: 'Базовые продукты из магазина',
...
const words = [
  { id: 1,  subtopic_id: 1, word_en: 'plate',  transcription_en: 'pleɪt',   translation_ru: 'тарелка',
    ...
    mnemonic_image_url: 'https://placehold.co/300x200?text=mnemonic', mnemo_text: 'ПЛЕТЁТ — тарелка плетёт узоры' },
  { id: 2,  subtopic_id: 1, word_en: 'cup',    transcription_en: 'kʌp',     translation_ru: 'чашка',
    ...
    mnemonic_image_url: 'https://placehold.co/300x200?text=mnemonic', mnemo_text: 'КАП — капает в чашку' },
  { id: 3,  subtopic_id: 1, word_en: 'fork',   transcription_en: 'fɔːrk',   translation_ru: 'вилка',
    ...
    mnemonic_image_url: 'https://placehold.co/300x200?text=mnemonic', mnemo_text: 'ФОРК — вилка ветвится как дерево' },
  { id: 4,  subtopic_id: 1, word_en: 'knife',  transcription_en: 'naɪf',    translation_ru: 'нож',
    ...
    mnemonic_image_url: 'https://placehold.co/300x200?text=mnemonic', mnemo_text: 'НАЙФ — найди нож на кухне' },
  { id: 5,  subtopic_id: 1, word_en: 'spoon',  transcription_en: 'spuːn',   translation_ru: 'ложка',
    ...
    mnemonic_image_url: 'https://placehold.co/300x200?text=mnemonic', mnemo_text: 'СПУН — спуниться над тарелкой с ложкой' },
  { id: 6,  subtopic_id: 1, word_en: 'bowl',   transcription_en: 'boʊl',    translation_ru: 'миска',
    ...
    mnemonic_image_url: 'https://placehold.co/300x200?text=mnemonic', mnemo_text: 'БОУЛ — круглая как для боулинга' },
